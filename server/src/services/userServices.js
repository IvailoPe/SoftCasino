...
const userService = {
    async register(username, password) {
        ...
        const user = new User({ username, password,gamesPlayes:0,rank:ranks.iron, rankBar:0,money:0,ordersMade:0,wonAmount:0,profilePicture:"https://i.pinimg.com/736x/c0/27/be/c027bec07c2dc08b9df60921dfd539bd.jpg",isPriceTaken:false });
